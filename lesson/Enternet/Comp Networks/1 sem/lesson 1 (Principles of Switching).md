...
![](png/lesson1/lesson1_TCP_IP.png)
...
![](png/lesson1/lesson1_LLC_MAC.png)
...
1. LLC(Logical Link Control) - уровень логических соединений, взаимодействует между сетевыми ПО на верхних слоях и
   аппаратным обеспечением устройств на нижних слоях. Помещает кадры в информацию, указывающую, какой протокол сетевого
   уровня используется для данного кадра. Данная информация позволяет различным протоколам 3 уровня использовать один и
   тот же сетевой интерфейс и одно и то же средство подключения.
2. MAC(Media Access Control) - уровень доступа к среде, определяет процессы доступа к среде, выполняемые оборудованием.
   Отвечает за инкапсуляцию данных и управлением доступа к среде передачи данных. Обеспечивает адресацию уровняю
   передачи данных и интегрирован с различными технологиями физического уровня
...
![](png/lesson1/lesson1_frames_link_level.png)
...
![](png/lesson1/lesson1_encapsulation_data.png)
...
![](png/lesson1/lesson1_EthernetFrameFields.png)
...
![](png/lesson1/lesson1_GET_INF.png)
...
![](png/lesson1/lesson1_Redirection.png)
...
![](png/lesson1/lesson1_FilterFrames.png)
...
![](png/lesson1/lesson1_BufferingFrames.png))

### Физические характеристики порта: дуплекс, скорость.

Физическими характеристиками порта являются пропускная способность и дуплексный режим. Важно, чтобы пропускная
